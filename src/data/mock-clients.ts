...
export type MapClient = {
  ...
  balance: number;
  lastOrder: string;
  /** Real geo coordinates (La Paz, Bolivia). */
  lat: number;
  lng: number;
};
...
export const mapClients: MapClient[] = [
  ...
  },
  {
    ...
    owner: 'Elena Apaza',
    route: 'Ruta 8',
    address: 'Plaza Alonso de Mendoza 12',
    phone: '+591 766 44120',
    visitToday: false,
    status: 'cerrado-observado',
    channel: 'tradicional',
...
export const routeBlocks: BlockPolygon[] = [
  block(-16.4948, -68.1392),
  block(-16.4948, -68.1376),
  block(-16.4948, -68.136),
  block(-16.4962, -68.1392),
  block(-16.4962, -68.1376),
  block(-16.4962, -68.136),
  block(-16.4976, -68.1376),
  block(-16.4976, -68.136),
];
